...
QQQJA 483"
  ...
  def is_straight(cards, 1),
    do:
      cards
      |> String.to_charlist()
      |> Enum.map(fn c -> @card_order[c] end)
      |> Enum.sort()
      |> is_straight_inner()

  def is_straight(cards, 2) do
    sorted =
      cards |> String.to_charlist() |> Enum.map(fn c -> @card_order_p2[c] end) |> Enum.sort()

    without_jokers = sorted |> Enum.filter(fn i -> i != 0 end)
    joker_count = 5 - Enum.count(without_jokers)
    is_straight_inner_jokers(without_jokers, joker_count)
  end

  def is_straight_inner([a, b, c, d, e])
      when b == a + 1 and c == a + 2 and d == a + 3 and e == a + 4,
      do: true

  def is_straight_inner(_), do: false

  def is_straight_inner_jokers([a, b, c], 2) do
    cond do
      b == a + 1 and c == a + 2 -> true
      b == a + 1 and c == a + 3 -> true
      b == a + 1 and c == a + 4 -> true
      b == a + 2 and c == a + 3 -> true
      b == a + 2 and c == a + 4 -> true
      b == a + 3 and c == a + 4 -> true
      true -> false
    end
  end

  def is_straight_inner_jokers([a, b, c, d], 1) do
    cond do
      b == a + 1 and c == a + 2 and d == a + 3 -> true
      b == a + 1 and c == a + 2 and d == a + 4 -> true
      b == a + 1 and c == a + 3 and d == a + 4 -> true
      b == a + 2 and c == a + 3 and d == a + 4 -> true
      true -> false
    end
  end
